                 ...
                 <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div className="form-group">
                              <div className="relative">
                                  ...
                                  <label htmlFor="username" className={`${style.inputLables}`}>Username:</label>
                        ...
                        <div className="form-group relative">
                          ...
                          <button
                              type="button"
                              className={`${style.SigninPasswordVisibility}`}
                        ...
                        <div className="form-group">
                            ...
                            <div className="relative">
                                ...
                                <label htmlFor="otp" className={`${style.inputLables}`}> One Time Password (OTP)</label>
                            </div>
                        ...
                        {/* Login button */}
                        <button type="submit" className={`${style.authButtons}`}> Log in</button>
