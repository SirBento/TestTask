...
function Hero() {
  return (
    <div className="relative w-full h-[600px] rounded-3xl overflow-hidden mt-20">
      <div
        className="absolute inset-0 bg-gradient-to-b from-[rgba(0,0,0,0.3)] to-[rgba(0,0,0,0.7)]"
      ></div>
      <div
        className="absolute inset-0 bg-[url('src/assets/hero.jpg')] bg-no-repeat bg-cover object-cover"
        style={{
      ...
      <div className="absolute inset-0 flex flex-col justify-end items-start text-white z-10 w-[640px] mb-10 pl-10">
        <div className="w-[540px] text-left">
          ...
          <p className="text-[16px] mb-8 leading-7">
        ...
        <div className="flex gap-3">
          <Link
            ...
            variant="gradient"
            size="sm"
            className="text-dimBlue lg:inline-block bg-lightBlue rounded-xl py-3 px-7 hover:bg-textBlueSecond hover:text-black font-poppins h-[46px] ml-3 font-medium"
          >
            <div className="flex items-center justify-between flex-row font-poppins text-borderBlue">
              <span className="ml-2 text-[14px] mr-1 font-poppins font-thin">Learn more</span>
