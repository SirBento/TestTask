...
navbar: "text-white p-4 flex justify-between items-center h-[80px]  top-0 fixed w-5/6 ",
...
form: "container mx-auto max-w-xl p-8 border border-borderBlue rounded-3xl shadow-md w-full md:w-1/2 lg:w-2/3 justify-center items-center",
