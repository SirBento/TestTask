const style = {
  ...
  navbar: "text-white p-4 flex justify-between h-[80px]  top-0 fixed  w-full z-10 py-4",


  headings: "text-[28px] font-bold text-center pb-10 pt-4 text-white font-poppins",

  headings2: "text-[36px] font-bold text-center pt-4 text-textBlue font-poppins",

  form: "container mx-auto max-w-xl p-8 border border-borderBlue rounded-3xl shadow-md w-full md:w-1/2 lg:w-2/3 justify-center items-center mb-12 mt-5",
  ...
  footer: "py-4 left-0 right-0 z-10 h-16  text-textWhite p-4 flex justify-between items-center text-[12px]  bottom-0 fixed font-poppins font-thin bottom-0 fixed ",
